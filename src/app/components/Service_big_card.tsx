            ...
            <div className=" h-[40rem] w-[55rem] bg-[#34353a] p-16 overflow-y-scroll">
                ...
                <div className="gap-3 flex flex-col">
                    ...
                    <h6>
                        ...
                        In today&apos;s digital world, your website is the first interaction consumers have with your business. That&aposs why almost 95 percent of a user&apos;s first impression relates to web design. It&apos;s also why web design services can have an immense impact on your company&apos;s bottom line.
                        That&apos;s why more companies are not only reevaluating their website&apos;s design but also partnering with Kura, the web design agency that&apos;s driven more than $2.4 billion in revenue for its clients. With over 50 web design awards under our belt, we&aposre confident we can design a custom website that drives sales for your unique business.
                    </h6>
                </div>
            </div>
        </div>
